...
fetch('https://api.openweathermap.org/data/2.5/forecast?lat=' + String(lat) + '&lon=' + String(long) + '&q='+String(country)+'&exclude=current.dt&appid=5b8bb692f48bc9b598d0069c5ec41b0f')
  ...
  .then(function (data) {
    ...
    document.getElementById("image-weather").innerHTML ='<img style="width:50px" src="https://openweathermap.org/img/wn/'+(data.list[0].weather[0].icon)+'@2x.png" alt="">';

    document.getElementById("flag").innerHTML ='<img src="https://openweathermap.org/images/flags/'+data.city.country.toLowerCase()+'.png" alt="">';
